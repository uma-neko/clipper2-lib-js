...
import { Rect64, Paths64, Clipper } from "../../src/Clipper2js";
...
describe(
  ...
  async () => {
    test("1. ", async () => {
      ...
      sub.clear();
      sub.push(Clipper.makePath64([208,66, 366,112, 402,303,
    ...
    test("2. Unexpected spike when clipping a long and narrow rectangle.", async () => {
      ...
      sub.push(Clipper.makePath64([700000, 6000,  0, 6000 , 0, 5925 ,  700000, 5925]));
      sol = Clipper.rectClip(rect, sub);
    ...
    test("3. Infinite loop.", async () => {
      ...
      let sol: Paths64;
      const rect = new Rect64(-1800000000n, -137573171n, -1741475021n, 3355443n);
      sub.push(Clipper.makePath64([-1800000000n, 10005000n,
        -1800000000n, -5000n, -1789994999n, -5000n, -1789994999n, 10005000n]));
