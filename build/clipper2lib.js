...
var __publicField = (obj, key, value) => {
  ...
  class Path64 extends Array {
    constructor(...args5) {
      ...
      if (args5.length === 0) {
        __super();
      } else if (typeof args5[0] === "number") {
        __super(args5[0]);
      } else {
        __super();
        this.pushRange(args5);
      }
  ...
  class PathDTypedArray {
    constructor(...args5) {
      ...
      } else if (args5[0] instanceof PathDTypedArray) {
        const startLength = args5[0].length;
        const startCapacity = startLength;
        this._innerLength = startLength;
        this._capacity = startCapacity;
        this._path = args5[0]._path.slice(0, startCapacity * 2);
      } else {
        const startCapacity = args5.length;
        this._capacity = startCapacity;
        this._innerLength = 0;
        this._path = new Float64Array(
          startCapacity * 2
  ...
  class Path64TypedArray {
    constructor(...args5) {
      ...
      } else if (args5[0] instanceof Path64TypedArray) {
        const startLength = args5[0].length;
        const startCapacity = startLength;
        this._innerLength = startLength;
        this._capacity = startCapacity;
